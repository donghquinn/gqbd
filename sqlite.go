...
func (qb *QueryBuilder) buildSQLiteSelect() (string, []interface{}, error) {
...
func (qb *QueryBuilder) buildSQLiteUpdate() (string, []interface{}, error) {
	if qb.data == nil {
...
func escapeSQLiteIdentifier(name string) (string, error) {
